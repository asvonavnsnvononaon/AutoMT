...
- [ADS: Data & Training Pipeline](#ads-data--training-pipeline)
- [M-Agent: Extracting MRs from Rules](#m-agent-extracting-mrs-from-rules)
- [T-Agent + RAG: MR Matching & Follow-Up Case Generation](#t-agent--rag-mr-matching--follow-up-case-generation)
- [Image Generation](#image-generation)
- [Video Generation](#video-generation)
- [Validation & Violation Metrics](#validation--violation-metrics)
---
